...
EXTERN Fms* Fms_CreateStick(char* name,
...
EXTERN void Fms_Initialize(Fms* fms,
...
EXTERN void Fms_Update(Fms* fms,
	/* Pointer to the fuel moisture stick object  */
...
EXTERN void Fms_UpdateAt(Fms* fms,
	/* Pointer to the fuel moisture stick object. */
	int    year, /* Year of the update  			(4 digits) */
	int    month, /* Month of the update		(1=Jan, 12=Dec) */
	int    day, /* Day of the update				   (1-31) */
...
EXTERN double CDT_DecimalDay(int hour, int minute, int second, int millisecond) ;
